...
model = "ising2d_sq_metro"
colors = plt.get_cmap('tab10')  # Colormap for different curves
...
for i, L in enumerate(L_array):
    ...
    ax[0, 0].plot(beta, specific_heat, color=colors(i), label=f'L={L}', marker='o', linestyle='-')
    ...
    ax[0, 1].plot(beta, susceptibility, color=colors(i), label=f'L={L}', marker='o', linestyle='-')
    ...
    ax[1, 0].plot(beta, magn_abs_avg, color=colors(i), label=f'L={L}', marker='o', linestyle='-')
    ...
    ax[1, 1].plot(beta, energy_avg, color=colors(i), label=f'L={L}', marker='o', linestyle='-')
